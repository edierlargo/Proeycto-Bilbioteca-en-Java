...
public class clsDAOPersona extends clsPersona {
    ...
    public boolean insertar() {
        String SQL = "INSERT INTO tbl_persona(ced, nom,ref,nomlibro,fecha) VALUES ('" + super.getId() + "','" + super.getNombre() + "','" + super.getRef() + "','" + super.getNomlibro() + "','" + super.getFecha() + "')";
        return con.procesarSQL(SQL);
    }

    public void borrar() {
        String SQL = "DELETE FROM tbl_persona WHERE ced='" + super.getId()+"'";
        con.procesarSQL(SQL);
    }

    public boolean modificar(){
        String SQL = "UPDATE tbl_persona SET nom='" + super.getNombre() + "',ced='" + super.getId() + "',ref='" + super.getRef() + "',nomlibro='" + super.getNomlibro() + "',fecha='" + super.getFecha() + "' WHERE ced='" + super.getId() + "'";
        return con.procesarSQL(SQL);
    }
public  java.util.ArrayList  consultar (){
      String sql="SELECT * FROM tbl_persona WHERE ced='" + super.getId() + "'"; 
